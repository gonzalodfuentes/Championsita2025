...
public class Personaje {
    ...
    public Personaje(float escala) {
        // Cargar texturas
        textureQuieto = new Texture("jugador/amarillo/Jugador.png");
        frameQuieto = new TextureRegion(textureQuieto);

        Texture sheetDerecha = new Texture("jugador/amarillo/jugadorCorriendoDerecha.png");
        Texture sheetIzquierda = new Texture("jugador/amarillo/jugadorCorriendoIzquierda.png");
        Texture sheetArriba = new Texture("jugador/amarillo/jugadorCorriendoArriba.png");
        Texture sheetAbajo = new Texture("jugador/amarillo/jugadorCorriendoAbajo.png");
        Texture sheetArribaDerecha = new Texture("jugador/amarillo/jugadorCorriendoArribaDerecha.png");
        Texture sheetArribaIzquierda = new Texture("jugador/amarillo/jugadorCorriendoArribaIzquierda.png");
        Texture sheetAbajoDerecha = new Texture("jugador/amarillo/jugadorCorriendoAbajoDerecha.png");
        Texture sheetAbajoIzquierda = new Texture("jugador/amarillo/jugadorCorriendoAbajoIzquierda.png");
