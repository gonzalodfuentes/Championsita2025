...
public class Futsal extends Menu {
    ...
    public Futsal(Principal juego, String modoDestino) {
        super(juego);
        this.modoDestino = modoDestino == null ? "futsal" : modoDestino;
    }
    ...
    public void render(float delta) {
        ...
        System.out.println("render modo fulvo");
        super.batch.end();
    }
