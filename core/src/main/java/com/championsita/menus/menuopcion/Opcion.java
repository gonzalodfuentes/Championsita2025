...
public class Opcion extends Menu {
    ...
    public void show() {
        ...
        this.colorSprite.setPosition(
                (super.anchoPantalla / 2f - this.colorSprite.getWidth() / 2f) - 250,
        ...
        for (int i = 0; i < this.niveles.values().length; i++) {
            ...
            this.opciones[i].setPosition(
                    (super.anchoPantalla / 2f - this.opciones[i].getWidth() / 2f) + 250,
